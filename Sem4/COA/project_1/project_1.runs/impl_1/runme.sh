...
HD_PWD='D:/Sem4/project_1/project_1.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log testand1.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source testand1.tcl -notrace
