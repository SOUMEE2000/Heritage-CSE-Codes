...
HD_PWD='D:/Sem4/project_1/project_1.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log testand1.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source testand1.tcl
